/* $Id: EmptyResourceBundle.java,v 1.4 2007/12/04 13:22:01 mke Exp $
 * $Revision: 1.4 $
...
/**
 * Helper class to represent an empty resource bundle when
 * none can be found
 */
...
public class EmptyResourceBundle extends ResourceBundle {
    ...
    public EmptyResourceBundle() {
        super();
        enumerator = new Enumeration<String>() {
    ...
    protected Object handleGetObject(String key) {
        if (key == null) {
            // We must throw a NPE according to RB spec
